---
name: ads
description: "Paid advertising audit and optimization skill for ICP qualification. Analyzes Meta, YouTube, and TikTok ads. Includes audit scoring, e-commerce strategy templates, brand DNA extraction, creative assessment, competitor analysis, and campaign brief generation."
argument-hint: "audit | meta | youtube | tiktok | creative | competitor | dna <url> | create | plan ecommerce"
license: MIT
---

# Ads: Paid Advertising Audit & Optimization (ICP-Qual Edition)

Ad account analysis focused on Meta, YouTube, and TikTok — the platforms most
relevant to DTC e-commerce ICP qualification. Orchestrates 9 specialized
sub-skills and 5 agents.

## Quick Reference

| Command | What it does |
|---------|-------------|
| `/ads audit` | Multi-platform audit with parallel subagent delegation |
...
| `/ads plan ecommerce` | Strategic e-commerce ad plan with templates |
...
**Path resolution:** All references are at `claude-ads/ads/references/` relative to the
`icp-qual` project root. When sub-skills or agents reference `ads/references/*.md`,
resolve to `icp-qual/claude-ads/ads/references/*.md`.
...
1. **ads-audit**: Multi-platform audit with parallel delegation
2. **ads-meta**: Meta Ads deep analysis (FB, IG, Advantage+)
3. **ads-tiktok**: TikTok Ads deep analysis
4. **ads-youtube**: YouTube Ads specific analysis
5. **ads-creative**: Cross-platform creative quality audit
6. **ads-competitor**: Competitor ad intelligence
7. **ads-dna**: Brand DNA extraction from website URL
8. **ads-create**: Campaign concepts, copy decks, creative briefs
9. **ads-plan**: Strategic e-commerce ad planning

## Subagents

For parallel analysis during full audits:
- `audit-meta`: Meta Ads checks (M01-M46)
- `audit-creative`: Creative quality for TikTok, YouTube
- `audit-compliance`: Compliance, settings, performance
- `creative-strategist`: Campaign concepts from brand profile + audit results
- `copy-writer`: Headlines, CTAs, primary text within platform limits
- `format-adapter`: Asset dimension validation and spec compliance reporting
