...
Load from `assets/` directory. This edition is focused on e-commerce:
- `ecommerce.md`: E-commerce stores (DTC brands, Shopify, BigCommerce, etc.)
- `ecommerce-creative.md`: E-commerce creative specifications and best practices
